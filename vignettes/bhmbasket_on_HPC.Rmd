...
The script is to be run on the master node.
```{r}
registerDoFuture()
...
Note that running this small example on a parallel backend will most likely not result in a performance improvement.
```{r}
