...
if (file.exists("analyses_lists/complex_analysis_1.rds")) {
  ...
  saveRDS(analyses_futility_1, "analyses_lists/1complex_analysis_1.rds")
}
...
## check for unnecessary data
  ...
  #   x[-c(2:4, 6), -c(1:3)]
  # })
  # analyses_futility_1$scenario_2$quantiles_list$exnex_adj <-   lapply(analyses_futility_1$scenario_1$quantiles_list$exnex_adj, function   (x) {
  #   x[-c(2:4, 6), -c(1:3)]
  # })
  # analyses_futility_1$scenario_3$quantiles_list$exnex_adj <-   lapply(analyses_futility_1$scenario_1$quantiles_list$exnex_adj, function   (x) {
  #   x[-c(2:4, 6), -c(1:3)]
  # })
  # analyses_futility_1$scenario_4$quantiles_list$exnex_adj <-   lapply(analyses_futility_1$scenario_1$quantiles_list$exnex_adj, function   (x) {
  #   x[-c(2:4, 6), -c(1:3)]
  # })
  # 
  
  ##subjects, responders, post_quantiles and prior_parameters
  # analyses_futility_1$scenario_1$scenario_data$n_subjects <- NULL
  # analyses_futility_1$scenario_2$scenario_data$n_subjects <- NULL
  # analyses_futility_1$scenario_3$scenario_data$n_subjects <- NULL
  # analyses_futility_1$scenario_4$scenario_data$n_subjects <- NULL
  
  # analyses_futility_1$scenario_1$scenario_data$n_responders <- NULL
  # analyses_futility_1$scenario_2$scenario_data$n_responders <- NULL
  # analyses_futility_1$scenario_3$scenario_data$n_responders <- NULL
  # analyses_futility_1$scenario_4$scenario_data$n_responders <- NULL
  
  analyses_futility_1$scenario_1$scenario_data$previous_analyses$post_quantiles <- NULL
  analyses_futility_1$scenario_2$scenario_data$previous_analyses$post_quantiles <- NULL
  analyses_futility_1$scenario_3$scenario_data$previous_analyses$post_quantiles <- NULL
  analyses_futility_1$scenario_4$scenario_data$previous_analyses$post_quantiles <- NULL
  
  #analyses_futility_1$scenario_1$analysis_parameters$prior_parameters_list <- NULL
  #analyses_futility_1$scenario_2$analysis_parameters$prior_parameters_list <- NULL
  #analyses_futility_1$scenario_3$analysis_parameters$prior_parameters_list <- NULL
  #analyses_futility_1$scenario_4$analysis_parameters$prior_parameters_list <- NULL
...
if (file.exists("analyses_lists/complex_analysis_2.rds")) {
  ...
  saveRDS(analyses_2, "analyses_lists/2complex_analysis_2.rds")
}
...
```{r, include = FALSE}
## check for unnecessary data
if (!is.null(analyses_2$scenario_1$scenario_data$previous_analyses$post_quantiles)) {
...
```{r, include = FALSE}
## check for unnecessary data
if (!is.null(analyses_3$scenario_1$scenario_data$previous_analyses$post_quantiles)) {
  ...
  #   x[-c(2, 4, 6), -c(1:4)]
  # })
  # analyses_3$scenario_2$quantiles_list$exnex_adj <-   lapply(analyses_3$scenario_1$quantiles_list$exnex_adj, function   (x) {
  #   x[-c(2, 4, 6), -c(1:4)]
  # })
  # analyses_3$scenario_3$quantiles_list$exnex_adj <-   lapply(analyses_3$scenario_1$quantiles_list$exnex_adj, function   (x) {
  #   x[-c(2, 4, 6), -c(1:4)]
  # })
  # analyses_3$scenario_4$quantiles_list$exnex_adj <-   lapply(analyses_3$scenario_1$quantiles_list$exnex_adj, function   (x) {
  #   x[-c(2, 4, 6), -c(1:4)]
  # })
  
  ## subjects, responders, post_quantiles and prior_parameters
  analyses_3$scenario_1$scenario_data$n_subjects <- NULL
  analyses_3$scenario_2$scenario_data$n_subjects <- NULL
  analyses_3$scenario_3$scenario_data$n_subjects <- NULL
  analyses_3$scenario_4$scenario_data$n_subjects <- NULL
  
  analyses_3$scenario_1$scenario_data$n_responders <- NULL
  analyses_3$scenario_2$scenario_data$n_responders <- NULL
  analyses_3$scenario_3$scenario_data$n_responders <- NULL
  analyses_3$scenario_4$scenario_data$n_responders <- NULL
  
  analyses_3$scenario_1$scenario_data$previous_analyses$post_quantiles <- NULL
  analyses_3$scenario_2$scenario_data$previous_analyses$post_quantiles <- NULL
  analyses_3$scenario_3$scenario_data$previous_analyses$post_quantiles <- NULL
  analyses_3$scenario_4$scenario_data$previous_analyses$post_quantiles <- NULL
