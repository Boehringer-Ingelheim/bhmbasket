...
A guide for a more simple BHM design implementation with the package [bhmbasket](https://cran.r-project.org/web/packages/bhmbasket/index.html) can be found in the vignette [Getting started](...).  
...
Cohort 4 is removed from the simulations as the recruitment of that cohort starts depending on the the analysis outcome of Cohort 1 in Analysis I.
