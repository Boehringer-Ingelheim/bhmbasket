...
if (any(grepl("w_",
 ...
 # quantiles_list
  ...
  ##subjects, responders, post_quantiles and prior_parameters
  for(s in seq_along(orr_scenario_list)) {
...
The probabilities of identifying the nugget cohorts are 72% and 70%.
The overall Go probability in the negative scenario is 2%.
