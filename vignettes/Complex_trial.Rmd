...
if (any(grepl("w_",
  ...
  for(k in 1:1000) {
    analyses_futility_1$scenario_1$quantiles_list$exnex_adj[[k]] <- analyses_futility_1$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
    analyses_futility_1$scenario_2$quantiles_list$exnex_adj[[k]] <- analyses_futility_1$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
    analyses_futility_1$scenario_3$quantiles_list$exnex_adj[[k]] <- analyses_futility_1$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
    analyses_futility_1$scenario_4$quantiles_list$exnex_adj[[k]] <- analyses_futility_1$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
  }
  rm(k)
...
if (any(grepl("w_",
  ...
  ## weights from quantiles_list
  for(k in 1:1000) {
    analyses_2$scenario_1$quantiles_list$exnex_adj[[k]] <- analyses_2$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1:4)]
    analyses_2$scenario_2$quantiles_list$exnex_adj[[k]] <- analyses_2$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1:4)]
    analyses_2$scenario_3$quantiles_list$exnex_adj[[k]] <- analyses_2$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1:4)]
    analyses_2$scenario_4$quantiles_list$exnex_adj[[k]] <- analyses_2$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1:4)]
  }
  rm(k)
...
if (file.exists("analyses_lists/complex_analysis_3.rds")) {
  ...
  #analyses_3 <- readRDS("analyses_lists/3complex_analysis_3.rds")
...
if (any(grepl("w_",
  ...
  ## weights from quantiles_list
  for(k in 1:1000) {
    analyses_3$scenario_1$quantiles_list$exnex_adj[[k]] <- analyses_3$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1:4)]
    analyses_3$scenario_2$quantiles_list$exnex_adj[[k]] <- analyses_3$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1:4)]
    analyses_3$scenario_3$quantiles_list$exnex_adj[[k]] <- analyses_3$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1:4)]
    analyses_3$scenario_4$quantiles_list$exnex_adj[[k]] <- analyses_3$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1:4)]
  }
  rm(k)
...
for(s in seq_along(orr_scenario_list)) {
  ...
  # update overall Go
  for(i in 1000){
    if(any(final_go_decisions[[s]]$decisions_list[[1]][i, c(2:5)])) {
      final_go_decisions[[s]]$decisions_list[[1]][i, 1] <- TRUE
    }
    if(all(final_nogo_decisions[[s]]$decisions_list[[1]][i, c(2:5)])) {
      final_nogo_decisions[[s]]$decisions_list[[1]][i, 1] <- TRUE
    }
  }
}
rm(i,s)
...
In case of the final analysis, the set of decision rules leads to an overall Go probability of 98% and individual Go probability of 73% in Cohort 1.
The probabilities of identifying the nugget cohorts are 71% and 70%.
