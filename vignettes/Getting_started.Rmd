...
if (any(grepl("w_",
  ...
  for(k in 1:10000) {
    analysis_list$scenario_1$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1:3)]
    analysis_list$scenario_2$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1:3)]
    analysis_list$scenario_3$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1:3)]
    analysis_list$scenario_4$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1:3)]
  }
  rm(k)
...
if (any(grepl("w_",
  ...
  ## weights from quantiles_list
  for(k in 1:10000) {
    final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1:4, 8)]
    final_analysis_list$scenario_2$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1:4, 8)]
    final_analysis_list$scenario_3$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1:4, 8)]
    final_analysis_list$scenario_4$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1:4, 8)]
  }
  rm(k)

  ##subjects, responders and post_quantiles
  for(s in seq_along(scenarios_list)) {
    final_analysis_list[[s]]$scenario_data$n_subjects <- final_analysis_list[[s]]$scenario_data$n_subjects[1,] #[1,] necessary for diff_21
  ...
  # for(k in 1:10000) {
  # final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][-c(1, 3, 7),]
  # final_analysis_list$scenario_2$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][-c(1, 3, 7),]
  # final_analysis_list$scenario_3$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][-c(1, 3, 7),]
  # final_analysis_list$scenario_4$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][-c(1, 3, 7),]
  # }
  # final_analysis_list[[1]]$analysis_parameters$quantiles <- c(0.050, 0.200, 0.500, 0.950)
  # final_analysis_list[[2]]$analysis_parameters$quantiles <- c(0.050, 0.200, 0.500, 0.950)
  # final_analysis_list[[3]]$analysis_parameters$quantiles <- c(0.050, 0.200, 0.500, 0.950)
  # final_analysis_list[[4]]$analysis_parameters$quantiles <- c(0.050, 0.200, 0.500, 0.950)
# save modified analysis list  
...
For Cohort 2, the relevance criterion $P(p_2|\text{data} > 0.29) > 0.5$ ∧ $P(p_2-p_1|\text{data} > 0) > 0.5$ is a combination of rules for the point estimate and for the difference between Cohort 2 and Cohort 1.
