...
if (file.exists("analyses_lists/gettingStarted_analysis_2.rds")) {
  ...
  saveRDS(final_analysis_list, "analyses_lists/gettingStarted_analysis_2.rds")
}
...
if (any(grepl("w_",
  ...
  ## weights from quantiles_list
  for(k in 1:10000) {
    final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
    final_analysis_list$scenario_2$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
    final_analysis_list$scenario_3$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
    final_analysis_list$scenario_4$quantiles_list$exnex_adj[[k]] <- final_analysis_list$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
  }
  rm(k)

  ##subjects, responders and post_quantiles
  for(s in seq_along(scenarios_list)) {
    #final_analysis_list[[s]]$scenario_data$n_subjects <- NULL
