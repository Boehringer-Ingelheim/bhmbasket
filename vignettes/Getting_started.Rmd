...
The resulting decision list can be used to calculate the cohort-wise and overall decision probabilities using the functions [`getGoProbabilities()`](https://search.r-project.org/CRAN/refmans/bhmbasket/html/getGoProbabilities.html).
...
Calling the printing function of the decision list leads automatically to the execution of `getGoProbabilities()`.
