...
#     x[,-c(1, 2, 3)]
#   })
#   analysis_list$scenario_2$quantiles_list$exnex_adj <-   lapply(analysis_list$scenario_1$quantiles_list$exnex_adj, function   (x) {
#     x[,-c(1, 2, 3)]
#   })
#   analysis_list$scenario_3$quantiles_list$exnex_adj <-   lapply(analysis_list$scenario_1$quantiles_list$exnex_adj, function   (x) {
#     x[,-c(1, 2, 3)]
#   })
#   analysis_list$scenario_4$quantiles_list$exnex_adj <-   lapply(analysis_list$scenario_1$quantiles_list$exnex_adj, function   (x) {
#     x[,-c(1, 2, 3)]
#   })
# 
# 
# for(k in 1:10000) {
#   analysis_list$scenario_1$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_1$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
#   analysis_list$scenario_2$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_2$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
#   analysis_list$scenario_3$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_3$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
#   analysis_list$scenario_4$quantiles_list$exnex_adj[[k]] <- analysis_list$scenario_4$quantiles_list$exnex_adj[[k]][,-c(1, 2, 3)]
# }

  # if(!is.null(analysis_list$scenario_1$scenario_data$previous_analyses$post_quantiles)) {
  # 
