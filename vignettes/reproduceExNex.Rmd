...
if (file.exists("analyses_lists/chugh_analysis.rds")) {
  
  chugh_analysis <- readRDS("analyses_lists/chugh_analysis.rds")
  ...
  saveRDS(chugh_analysis, "analyses_lists/chugh_analysis.rds")
...
analyses_list <- performAnalyses(
  ...
  saveRDS(analyses_list, "analyses_lists/1analyses_list.rds")
```

```{r performAnalyses, include = FALSE}
prior_parameters <- setPriorParametersExNex(
  mu_mean   = c(logit(0.1), logit(0.3)),
  mu_sd     = c(3.18, 1.94),
  tau_scale = 1,
...
if (file.exists("analyses_lists/analyses_list.rds")) {
  
  analyses_list <- readRDS("analyses_lists/analyses_list.rds")
  ...
  saveRDS(analyses_list, "analyses_lists/analyses_list.rds")
