...
getUniqueTrialsNormal <- function(
  ...
  # 1) Collect per-cohort means for each trial
  ...
  # 2) Align cohorts across all trials
  ...
  # 4) Bin per cohort and create signatures
  ...
  # one group = one bin-pattern (signature) across cohorts
